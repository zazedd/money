  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> waitingUsersRowList = snapshot.data!;
        final waitingUsersRow =
            waitingUsersRowList.isNotEmpty ? waitingUsersRowList.first : null;
            ...
            body: SafeArea(
              ...
              child: Align(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    if (waitingUsersRow?.role == 0 ? false : false) {
                      context.pushNamed('homePageCEO');
                    } else {
                      if (waitingUsersRow?.role == 1 ? false : false) {
                        context.pushNamed('homePageEmpreendedor');
                      } else {
                        context.pushNamed('homePageTrabalhador');
                      }
                    }
                  },
                  text: 'continuar',
