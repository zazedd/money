                        ...
                        return Container(
                          ...
                          child: CarouselSlider.builder(
                            ...
                            itemBuilder: (context, carouselIndex, _) {
                              final carouselWorkRow =
                                  carouselWorkRowList[carouselIndex];
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 25.0),
                                child: InkWell(
                                                              ...
                                                              child:
                                                                ...
                                                                percent:
                                                                  ...
                                                                  ((getCurrentTimestamp.secondsSinceEpoch.toDouble() -
                                                                              carouselWorkRow.startsAt!.secondsSinceEpoch
                                                                                  .toDouble()) /
                                                                          (carouselWorkRow.endsAt!.secondsSinceEpoch.toDouble() -
                                                                              carouselWorkRow.startsAt!.secondsSinceEpoch
                                                                                  .toDouble()))
                                                                      .clamp(
                                                                          0.0,
                            ...
                            options: CarouselOptions(
                              initialPage:
                                  min(0, carouselWorkRowList.length - 1),
