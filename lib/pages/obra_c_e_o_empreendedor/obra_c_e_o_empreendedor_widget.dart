                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          FutureBuilder<
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              List<MaterialRow> textMaterialRowList = snapshot.data!;
                                                                              final textMaterialRow = textMaterialRowList.isNotEmpty ? textMaterialRowList.first : null;
                                                                              return Text(
                                                                                valueOrDefault<String>(
                                                                    ...
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          '${valueOrDefault<String>(
                                                                            bottomSheetMatWorkRowList.where((e) => e.materialId == listViewMaterialRow.id).toList().first.quantity?.toString(),
                                                                            '0',
